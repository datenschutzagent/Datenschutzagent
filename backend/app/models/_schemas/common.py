...
DocumentFormatEnum = Literal[
    "docx", "pdf", "xlsx", "pptx", "csv", "doc", "jpg", "png", "tiff"
]
...
FindingStatusEnum = Literal[
    ...
    FindingStatus.OVERRULED,
    FindingStatus.FIXED,
]
CaseLanguageEnum = Literal["de", "en", "de_en"]
ExtractionMethodEnum = Literal[
    DocumentExtractionMethod.TEXT, DocumentExtractionMethod.OCR
]
ExtractionStatusEnum = Literal[
    DocumentExtractionStatus.PENDING,
    DocumentExtractionStatus.PROCESSING,
    DocumentExtractionStatus.DONE,
