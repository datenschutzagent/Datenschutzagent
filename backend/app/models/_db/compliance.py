...
class AVVContractModel(Base):
    ...
    partner_type: Mapped[str] = mapped_column(String(50), nullable=False, default="processor")
...
class PrivacyPolicyModel(Base):
    ...
    __table_args__ = (
        Index("ix_privacy_policies_case_id", "case_id"),
    )
    ...
    case: Mapped["CaseModel"] = relationship("CaseModel", back_populates="privacy_policies")
