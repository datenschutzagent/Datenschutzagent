...
class RunChecksJobModel(Base):
    ...
    __table_args__ = (
        Index("ix_run_checks_jobs_case_id_created_at", "case_id", "created_at"),
    )
...
class DSBReportModel(Base):
    ...
    basis_document_count: Mapped[int] = mapped_column(
        Integer, nullable=False, default=0
    )
    basis_last_run_checks_at: Mapped[datetime | None] = mapped_column(
...
class DSBReportJobModel(Base):
    ...
    __table_args__ = (
        Index("ix_dsb_report_jobs_case_id_created_at", "case_id", "created_at"),
    )
