...
router.include_router(
    admin_prompt_templates.router, prefix="/admin/prompt-templates", tags=["admin"]
)
...
router.include_router(
    vvt_overview.router, prefix="/vvt-overview", tags=["vvt-overview"]
)
router.include_router(dsfa.router, prefix="/cases", tags=["dsfa"])
router.include_router(dsr.router, prefix="/dsr", tags=["dsr"])
router.include_router(
    data_breaches.router, prefix="/data-breaches", tags=["data-breaches"]
)
router.include_router(avv.router, prefix="/avv", tags=["avv"])
router.include_router(tom.router, prefix="/tom", tags=["tom"])
router.include_router(
    case_templates.router, prefix="/case-templates", tags=["case-templates"]
)
router.include_router(
    privacy_policy.router, prefix="/privacy-policies", tags=["privacy-policy"]
)
router.include_router(
    privacy_policy.case_scoped_router, prefix="/cases", tags=["privacy-policy"]
)
router.include_router(webhooks.router, prefix="/admin/webhooks", tags=["admin"])
router.include_router(analytics.router, prefix="/analytics", tags=["analytics"])
router.include_router(mitigations.router, tags=["mitigations"])
