...
PROMPT_TEMPLATE_KEY_META: list[dict[str, Any]] = [
    {
        ...
        "description": "Einzeldokument, Full-Text, System",
        "placeholders": ["language_hint"],
    },
    {
        "key": "check_full_text_document_user",
        "description": "Einzeldokument, Full-Text, User",
        "placeholders": ["requirement", "document_text"],
    },
    {
        "key": "check_full_text_cross_system",
        "description": "Vorgang, Full-Text, System",
        "placeholders": ["language_hint"],
    },
    {
        "key": "check_full_text_cross_user",
        "description": "Vorgang, Full-Text, User",
        "placeholders": ["requirement", "documents"],
    },
    {
        "key": "check_rag_document_system",
        "description": "Einzeldokument, RAG, System",
        "placeholders": ["language_hint"],
    },
    {
        "key": "check_rag_document_user",
        "description": "Einzeldokument, RAG, User",
        "placeholders": ["requirement", "excerpts"],
    },
    {
        "key": "check_rag_cross_system",
        "description": "Vorgang, RAG, System",
        "placeholders": ["language_hint"],
    },
    {
        "key": "check_rag_cross_user",
        "description": "Vorgang, RAG, User",
        "placeholders": ["requirement", "excerpts"],
    },
    {
        "key": "vvt_system",
        "description": "VVT-Normalisierung, System",
        "placeholders": ["language_hint"],
    },
    {
        "key": "vvt_user",
        "description": "VVT-Normalisierung, User",
        "placeholders": ["field_list", "document_text"],
    },
]
...
async def get_active_template(key: str) -> str | None:
    ...
    async with async_session_factory() as session:
        result = await session.execute(
            select(PromptTemplateModel.content)
            .where(
