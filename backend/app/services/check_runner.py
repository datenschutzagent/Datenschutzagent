...
CHECK_OUTPUT_GUIDANCE = (
    ...
    "The document text may contain page anchors ('[Seite N]') and row-numbered tables "
    "(leading 'Zeile' column): cite these locations in description/recommendation "
    "(e.g. 'Seite 3', 'Zeile 12'), but keep evidence quotes verbatim.\n"
