...
async def _avv_pipeline(
    ...
    avv_q = text(  # nosemgrep: python.sqlalchemy.security.audit.avoid-sqlalchemy-text.avoid-sqlalchemy-text
        f"""
...
async def _tom_pipeline(
    ...
    tom_q = text(  # nosemgrep: python.sqlalchemy.security.audit.avoid-sqlalchemy-text.avoid-sqlalchemy-text
        f"""
        SELECT category,
...
async def _dsfa_coverage(db: AsyncSession, params: dict[str, Any]) -> dict[str, Any]:
    ...
    dsfa_q = text(  # nosemgrep: python.sqlalchemy.security.audit.avoid-sqlalchemy-text.avoid-sqlalchemy-text
        f"""
