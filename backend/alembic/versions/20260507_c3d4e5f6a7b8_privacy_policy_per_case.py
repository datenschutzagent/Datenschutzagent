...
def upgrade() -> None:
    ...
    op.execute("ALTER TABLE IF EXISTS privacy_policies DROP COLUMN IF EXISTS department")
...
def downgrade() -> None:
    ...
    op.execute("ALTER TABLE IF EXISTS privacy_policies DROP CONSTRAINT IF EXISTS privacy_policies_case_id_fkey")
    ...
    op.execute("ALTER TABLE IF EXISTS privacy_policies ADD COLUMN IF NOT EXISTS org_name VARCHAR(300)")
    op.execute("ALTER TABLE IF EXISTS privacy_policies ADD COLUMN IF NOT EXISTS department VARCHAR(200)")
